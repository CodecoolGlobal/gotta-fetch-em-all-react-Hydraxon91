...
function MainPage(props) {
  ...
  return !IntroPlayed ? (
    ...
    <div>
      <h1 className="my-5">POKEMON LAND</h1>
      <p
        style={{ display: "inline", padding: "3px", backgroundColor: "white" }}
      >
        Current coins: {props.playerCoins}
      </p>
      <button style={{ display: "inline" }} onClick={healPokemons}>
        Heal Pokemons for 10 coins
      </button>
